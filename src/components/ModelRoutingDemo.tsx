...
export function ModelRoutingDemo() {
  ...
  return (
    <div className="model-routing-demo">
      ...
      {/* Results */}
      {result && (
        <div className="demo-results" style={{ marginTop: '24px', padding: '20px', background: '#f9fafb', borderRadius: '12px', border: '2px solid #e5e7eb' }}>
              ...
              <div style={{ marginTop: '4px' }}>
                <div style={{
                  ...
                  <div style={{
                    ...
                    height: '100%',
                    background: result.confidence > 0.8 ? '#10b981' : result.confidence > 0.6 ? '#f59e0b' : '#ef4444',
      ...
      <div style={{ marginTop: '24px', padding: '16px', background: '#eff6ff', borderRadius: '8px', border: '1px solid #bfdbfe' }}>
        ...
        <ul style={{ margin: 0, paddingLeft: '20px', color: '#374151', fontSize: '14px' }}>
          <li><strong>Execution tasks</strong> → Cascade Agent (direct environment access)</li>
          <li><strong>Analysis tasks</strong> → Claude 3.5 Sonnet (deep reasoning)</li>
          <li><strong>Creative tasks</strong> → GPT-4 (content generation)</li>
        </ul>
      </div>
    </div>
  );
